  ...
  return (
    <>
      ...
      <main className="page">
        ...
        {!user ? (
          <p>
            Please <a href="/login">log in</a> to view messages.
          </p>
        ) : (
          <div className="inbox">
            <aside>
              {items.map((conversation) => (
                <button
                  className={
                    "conversation " +
                    (conversation.id === current?.id ? "selected" : "")
                  }
                  onClick={() => open(conversation.id)}
                  key={conversation.id}
                >
                  <b>{other(conversation)?.name}</b>
                  <small>
              ...
              {!items.length && (
                <p className="muted">
                  Message a landlord from a room listing to begin.
                </p>
              )}
            </aside>
